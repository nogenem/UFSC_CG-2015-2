...
void BSplineSurface::generateSurface(const Coordinates& cpCoords){
    ...
    double delta_s = 1.0 / (m_ns-1);
    double delta_t = 1.0 / (m_nt-1);
...
void BSplineSurface::createDeltaMatrices(double delta_s, double delta_t){
    // s
    double s = delta_s;
    double s2 = s*s;
    double s3 = s2*s;
...
void BSplineSurface::createCurve(double n,
